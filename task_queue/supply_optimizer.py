...
class EnergySystemOptimizer:
    ...
    def optimize(self):  # noqa: C901,PLR0912,PLR0915 TODO refactor function / build system through tabular instead
        ...
        if self.H2_system:
            ...
            fuel_cell = _build_generic_transformer("fuel_cell", self.fuel_cell, bus_in=b_h2, bus_out=b_el_dc)
            electrolyzer = _build_generic_transformer("electrolyzer", self.electrolyzer, bus_in=b_el_dc, bus_out=b_h2)
